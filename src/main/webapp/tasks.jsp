        ...
        function fetchUserProfile() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#employeeName").text(response.data.firstName + " " + response.lastName);
                ...
                error: function(xhr, status, error) {
                    ...
                    $("#userId").text("Error loading data");
                    $("#employeeName").text("");
...
<div id="editModal" class="modal">
    <div class="modal-content">
        ...
        <h2>Edit Profile</h2>
        <form action="updateProfile" method="post" id="editProfileForm">
						...
						.addEventListener(
								...
								function() {
									...
									var phoneInput = document
											.getElementById("contact_no");
									var form = document
											.getElementById("editProfileForm"); // Replace "profileForm" with your form ID
